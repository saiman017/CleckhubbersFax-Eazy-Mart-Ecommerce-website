...
$query = "SELECT Customer_ID, First_Name || ' ' || Last_Name AS Customer_Name, Contact_Number, Address, Gender, Email, Register_Date, Username 
          FROM Customer ";
...
<body>
    ...
    while ($row = oci_fetch_assoc($result)) {
        ...
        echo '<td><a href="delete_customer.php?id=' . $row['CUSTOMER_ID'] . '" class="btn btn-danger btn-sm">Delete</a></td>';
        echo "</tr>";
    }
    ?>
                    </tbody>
