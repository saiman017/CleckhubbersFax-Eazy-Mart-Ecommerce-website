...
$query = "SELECT Trader_ID,First_Name || ' ' || Last_Name AS Trader_Name, Contact_Number, Address,  Gender, Email, Register_Date, Username  FROM TRADER WHERE TRADER_STATUS = 1";
                ...
                <table class="table table-hover table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        while ($row = oci_fetch_assoc($result)) {
                            ...
                            echo '<td><a href="deleteTrader.php?id=' . $row['TRADER_ID'] . '" class="btn btn-danger btn-sm">Delete</a></td>';
                            echo "</tr>";
                        }
                        ?>
                    </tbody>
